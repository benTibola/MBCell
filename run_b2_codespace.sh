...
cp KELLY_LOCAL_ENVELOPE_PROXY_step*.csv B2_public_run_01_min/ 2>/dev/null || true
printf 'Built public deal.II cylinder run for first slab [0.00,0.01] with Kelly-led non-provisional local proxy export.\n' > B2_public_run_01_min/RUN_METADATA.txt
